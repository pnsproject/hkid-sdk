...
export interface NameControllerInterface extends utils.Interface {
  functions: {
...
export interface NameController extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NameControllerInterface;
  ...
  filters: {
    ...
    PriceChanged(basePrices?: null, rentPrices?: null): PriceChangedEventFilter;
